<%@ page contentType="text/html; charset=UTF-8" language="java" %>
    ...
    <body>
        ...
        <div class="main">
            <button id="addNoteButton" class="button1 floatR" onclick="addNote()">Nova Nota</button>
            <!-- Lista de Notas -->
            <h2>Notas:</h2>
            <ul id="noteList"></ul>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $.each(data, function (index, note) {
                            ...
                            $('#noteList').append('<li><span>' + note.name +
                                '</span><div class="cb"><button class="button2" onclick="editNoteConfirmation(' + note.id + ')">Editar</button>' +
